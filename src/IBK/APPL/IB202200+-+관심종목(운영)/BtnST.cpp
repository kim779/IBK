...
// Parameters:
//		[IN]	lpszText
//				Pointer to a nullptr-terminated string containing the text to show.
//		[IN]	bActivate
//				If TRUE the tooltip will be created active.
//
...
// Parameters:
//		[IN]	lpszURL
//				Pointer to a nullptr-terminated string that contains the URL.
