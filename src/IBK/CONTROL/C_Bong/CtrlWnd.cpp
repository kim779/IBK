...
void CCtrlWnd::AddControlClass(int key, CRect rc, CString text)
{
	...
	{
	case ctl_ZOOMOUT:
		pInfoCTL->imgup = IMG_ZOOMOUT;
		pInfoCTL->imgdown = IMG_ZOOMOUT + 2;
		break;
	case ctl_ZOOMIN:
		pInfoCTL->imgup = IMG_ZOOMIN;
		pInfoCTL->imgdown = IMG_ZOOMIN + 2;
		break;
	case ctl_PRE:
		pInfoCTL->imgup = IMG_PRE;
		pInfoCTL->imgdown = IMG_PRE + 2;
		break;
	case ctl_STOP:
		pInfoCTL->imgup = IMG_STOP;
		pInfoCTL->imgdown = IMG_STOP + 2;
		break;
	case ctl_NEXT:
		pInfoCTL->imgup = IMG_NEXT;
		pInfoCTL->imgdown = IMG_NEXT + 2;
		break;
	case ctl_EXCEL:
		pInfoCTL->imgup = IMG_EXCEL;
