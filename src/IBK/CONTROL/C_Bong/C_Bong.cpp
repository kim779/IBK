// C_Bong.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CC_BongApp, CWinApp)
	//{{AFX_MSG_MAP(CC_BongApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CC_BongApp object

CC_BongApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CC_BongApp initialization

BOOL CC_BongApp::InitInstance()
{
...
CPen* CC_BongApp::GetPen(CWnd *pView, int style, int width, COLORREF clr)
{
	_penR rPen;
	rPen.clr = clr;
	rPen.width = width;
...
CBrush* CC_BongApp::GetBrush(CWnd *pView, COLORREF rColor)
{
