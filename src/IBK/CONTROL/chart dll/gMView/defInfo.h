...
#define IMG_TABLE	"GTM_TABLE.bmp"
#define IMG_CELL	"GTM_CELL.bmp"
#define IMG_CHECK	"GTM_CHECK.bmp"
...
enum {	BTN_CFG = 0, CMB_UNIT, /** macho add **/BTN_UNIT, CMB_KKIND, CMB_CODE, 
	BTN_CODE, BTN_MATRIX, BTN_MERGE, BTN_CHECK, BTN_FOCUS, 
	BTN_K200, BTN_FUTURE,
	BTN_FO1, BTN_FO2, BTN_FO3, BTN_FO4, BTN_FO5,
	CHK_SELECT, BTN_DDAY, BTN_DWEEK, BTN_DMON,
	BTN_DMIN, BTN_DTICK, BTN_DOLLAR, CMB_TIME, CMB_GIGAN, BTN_TIME1,
	BTN_TIME2, BTN_TIME3, BTN_TIME4, BTN_TIME5, STC_GIGAN, EDT_GIGAN,
	STC_DISP, EDT_DISP, CALENDAR, CHK_TODAY, BTN_MENU,
	BTN_SAVE, BTN_TOOL, STC_JNAME, BTN_GIGAN2, BTN_ORDER, BTN_INIT};
