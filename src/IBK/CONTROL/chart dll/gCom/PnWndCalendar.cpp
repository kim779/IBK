...
BOOL CPnWndCalendar::OnFormat(NMDATETIMEFORMAT* /*lpNMFormat*/, LRESULT* pResult)
{
	*pResult = 0;
	return FALSE;
}
...
BOOL CPnWndCalendar::OnUserString(NMDATETIMESTRING* /*lpDTstring*/, LRESULT* pResult)
{
	*pResult = 0;
	return FALSE;
}

BOOL CPnWndCalendar::OnKeyDown(NMDATETIMEWMKEYDOWN* /*lpDTKeystroke*/, LRESULT* pResult)
{
	*pResult = 0;
	return FALSE;
}
